...
> :warning: All catch blocks should be ordered from most specific to most general. Following the specific exceptions, you can use the Exception type to handle all other exceptions as the last catch.
...
<p align="center">
	<img src="./images/java-intermediate-03-03-p01-a.png" alt="./images/java-intermediate-03-03-p01-a.png" width="50%" height="50%">
</p>
...
> :warning: Use the get method and the corresponding key to access the HashMap elements.
